...
IGL_INLINE void igl::opengl::MeshGL::bind_mesh()
{
  ...
  glBindTexture(GL_TEXTURE_BUFFER, vbo_tex);
  glTexBuffer(GL_TEXTURE_BUFFER,GL_RGBA16F, tbo);
  GLint buf_loc = glGetUniformLocation(shader_mesh,"buf");
  glUniform1i(buf_loc, 0);
